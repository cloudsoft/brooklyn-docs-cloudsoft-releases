...
function help() {
  ...
  echo "* guide-version : to build the guide only, in the versioned namespace /v/1.2.0-cloudsoft-amp-7.3.1-20260401-1503/"
...
function parse_mode() {
  ...
  guide-version)
    ...
    DIRS_TO_MOVE[0]=guide
    # BROOKLYN_VERSION_BELOW
    DIRS_TO_MOVE_TARGET[0]=v/1.2.0-cloudsoft-amp-7.3.1-20260401-1503
    DIRS_TO_MOVE[1]=style
    STYLE_SUBDIR=${DIRS_TO_MOVE_TARGET[0]}/style
    DIRS_TO_MOVE_TARGET[1]=$STYLE_SUBDIR
    INSTALL_RSYNC_OPTIONS=""
